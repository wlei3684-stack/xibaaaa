...
class Got10k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        if any(i < 0 or i >= len(self.sequence_list) for i in seq_ids):
            raise ValueError("GOT10k split indices do not match list.txt; check root/split and dataset completeness")
