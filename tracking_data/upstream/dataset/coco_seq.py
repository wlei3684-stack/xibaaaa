...
from tracking_data.upstream.data import jpeg4py_loader
import torch
import random
from pycocotools.coco import COCO
from collections import OrderedDict
from tracking_data.upstream.admin import env_settings
...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, data_fraction=None, split="train", version="2014", image_dir=None, annotation_file=None):
        """
        args:
        ...
        if image_dir is not None: self.img_pth = image_dir
        if annotation_file is not None: self.anno_path = annotation_file
